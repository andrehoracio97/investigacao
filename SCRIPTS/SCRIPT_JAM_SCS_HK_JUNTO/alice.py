...
class alice(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        ##################################################
        self.sps = sps = 4
        self.samp_rate_array_MCR = samp_rate_array_MCR = [405405.4054,375000,312500,200000,100000]
        ...
        self.punc_pattern = punc_pattern = 33554431
        ...
        self.blocks_file_source_0_0_1_0_0_0_1_0 = blocks.file_source(gr.sizeof_char*1, '/home/andre/Desktop/Files_To_Transmit/trasmit_10_mb.txt', False)
        self.blocks_file_source_0_0_1_0_0_0_1_0.set_begin_tag(pmt.PMT_NIL)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_file_source_0_0_1_0_0_0_1_0, 0), (self.blocks_repack_bits_bb_1_0_0_1, 0))
