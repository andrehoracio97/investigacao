...
class eve(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.variable_qtgui_range_0_1 = variable_qtgui_range_0_1 = 64
        ...
        # Blocks
        ##################################################
        self._variable_qtgui_range_0_1_range = Range(0, 73, 1, 64, 200)
        ...
        self.blocks_file_sink_0_0_0_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/andre/ELI/LMS70/EVE_55_200000_BRUTO.txt', False)
        self.blocks_file_sink_0_0_0_0_0.set_unbuffered(True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/andre/ELI/LMS70/EVE_EVM.txt', False)
