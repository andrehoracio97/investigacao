...
class bob_dec(gr.top_block):

    def __init__(self, puncpat='11'):
        gr.top_block.__init__(self, "Bob Dec")
        ...
        self.blocks_keep_m_in_n_0_0_2_0_0_0 = blocks.keep_m_in_n(gr.sizeof_char, 1020, 1024, 0)
        self.blocks_keep_m_in_n_0_0_2_0_0 = blocks.keep_m_in_n(gr.sizeof_char, 1100, 1105, 0)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/it/ELI/'+num+'/BOB_54_8000_BRUTO.txt', False)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0_0_0_2 = blocks.file_sink(gr.sizeof_char*1, '/home/it/ELI/'+num+'/BOB_54_8000.txt', False)
        ...
        self.connect((self.blocks_keep_m_in_n_0_0_2_0_0_0, 0), (self.puncture64_cpp_depuncture64_0, 0))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.blocks_keep_m_in_n_0_0_2_0_0_0, 0))
...
def main(top_block_cls=bob_dec, options=None):
    if options is None:
