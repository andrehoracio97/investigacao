...
#include <math.h>
#include <stdio.h>
#define mm  5           /* RS code over GF(2**4) - change to suit */
#define nn  31          /* nn=2**mm -1   length of codeword */
...
printf("How many bits? (DEFAULT=1104 bits = 138bytes de payload)");
