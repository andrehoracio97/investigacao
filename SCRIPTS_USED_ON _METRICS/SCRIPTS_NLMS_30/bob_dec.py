...
class bob_dec(gr.top_block):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/it/ELI/'+num+'/BOB_55_8000_BRUTO.txt', False)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0_0_0_2 = blocks.file_sink(gr.sizeof_char*1, '/home/it/ELI/'+num+'/BOB_55_8000.txt', False)
