...
class eve_dec(gr.top_block):
    ...
    def __init__(self, puncpat='11'):
        ...
        # Variables
        ##################################################
        self.H_dec = H_dec = fec.ldpc_H_matrix('/usr/local/share/gnuradio/fec/ldpc/n_1800_k_0902_gap_28.alist', 28)
        ...
        self.blocks_keep_m_in_n_0_1_1_0 = blocks.keep_m_in_n(gr.sizeof_char, 896, 902, 0)
