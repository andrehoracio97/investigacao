...
class eve(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.variable_qtgui_range_0_1 = variable_qtgui_range_0_1 = power
        ...
        self.pld_dec = pld_dec = map((lambda a: fec.ldpc_bit_flip_decoder.make(H_dec.get_base_sptr(), 7)), range(0,8))
        ...
        # Blocks
        ##################################################
        self._variable_qtgui_range_0_1_range = Range(0, 73, 1, power, 200)
        ...
        self.blocks_file_sink_0_0_0_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/andre/ELI/'+num+'/EVE_55_8000_BRUTO.txt', False)
        self.blocks_file_sink_0_0_0_0_0.set_unbuffered(True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/andre/ELI/'+num+'/EVE_EVM.txt', False)
        ...
        self.connect((self.blocks_keep_m_in_n_0_0_2_0_0, 0), (self.blocks_repack_bits_bb_0_0_0_1_0, 0))
