...
# Title: Tx Stage4
# Generated: Mon Jul 22 12:47:14 2019
##################################################
...
class tx_stage4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tx Stage4")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tx Stage4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_stage4")
        ...
        self.hdr_format = hdr_format = digital.header_format_default(digital.packet_utils.default_access_code, thresh, 1)
...
def main(top_block_cls=tx_stage4, options=None):
