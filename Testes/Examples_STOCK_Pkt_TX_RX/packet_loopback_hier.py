...
# Generated: Wed Jul 24 12:38:41 2019
##################################################
...
class packet_loopback_hier(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_tag_debug_0_0 = blocks.tag_debug(gr.sizeof_gr_complex*1, 'HPD OUT', ""); self.blocks_tag_debug_0_0.set_display(True)
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 100, 'pacote')
        self.blocks_pdu_to_tagged_stream_1 = blocks.pdu_to_tagged_stream(blocks.byte_t, 'pacote')
        ...
        self.connect((self.packet_rx_0, 1), (self.blocks_tag_debug_0_0, 0))
