...
# Title: Top Block
# Generated: Mon Jul 15 17:44:53 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_crc32_bb_1 = digital.crc32_bb(True, length_tag_key, True)
        ...
        self.blocks_throttle_2_0_0 = blocks.throttle(gr.sizeof_char*1, samp_rate,True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_char*1, samp_rate,True)
        self.blocks_tagged_stream_mux_0 = blocks.tagged_stream_mux(gr.sizeof_char*1, length_tag_key, 0)
        self.blocks_tag_debug_1_1_0_0_1_0_1 = blocks.tag_debug(gr.sizeof_gr_complex*1, 'Tx Bytes_Mux_COMPARA', ""); self.blocks_tag_debug_1_1_0_0_1_0_1.set_display(True)
        ...
        self.blocks_repack_bits_bb_0_0 = blocks.repack_bits_bb(qpsk.bits_per_symbol(), 8, length_tag_key, False, gr.GR_LSB_FIRST)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/andre/testes/output.txt', False)
        ...
        self.connect((self.blocks_throttle_2_0_0, 0), (self.blocks_file_sink_0, 0))
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.blocks_tag_debug_1_1_0_0_1_0_1, 0))
        self.connect((self.digital_costas_loop_cc_0, 0), (self.digital_header_payload_demux_0, 0))
        self.connect((self.digital_crc32_bb_0, 0), (self.blocks_repack_bits_bb_0, 0))
        self.connect((self.digital_crc32_bb_1, 0), (self.blocks_throttle_2_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_throttle_2_0_0.set_sample_rate(self.samp_rate)
