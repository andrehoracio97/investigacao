...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_2_win, 1, 4, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.digital_burst_shaper_xx_0 = digital.burst_shaper_cc((firdes.window(firdes.WIN_HANN, 5, 5)), 0, filt_delay, True, 'packet_len')
        ...
        self.blocks_stream_to_tagged_stream_0_0_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 1200, "packet_len")
        ...
        self.connect((self.digital_constellation_soft_decoder_cf_0_0, 0), (self.qtgui_time_sink_x_2, 0))
        ...
        self.connect((self.digital_fll_band_edge_cc_0, 0), (self.qtgui_const_sink_x_0_0_0_1, 0))
        self.connect((self.digital_fll_band_edge_cc_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0_0, 0), (self.digital_fll_band_edge_cc_0, 0))
