...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.blocks_repack_bits_bb_1_0_0 = blocks.repack_bits_bb(1, 2, '', False, gr.GR_MSB_FIRST)
        ...
        self.connect((self.blocks_repack_bits_bb_1_0_0, 0), (self.digital_map_bb_1_0, 0))
