...
class tx_no_gui(gr.top_block):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.pld_enc = pld_enc = map( (lambda a: fec.ccsds_encoder_make(440, 0, fec.CC_TERMINATED)), range(0,8) );
        ...
        self.blocks_file_source_0_0_1_0_0_1 = blocks.file_source(gr.sizeof_char*1, '/home/andre/Desktop/Files_To_Transmit/trasmit_10_mb.txt', False)
