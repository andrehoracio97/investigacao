...
class rx_recive(gr.top_block, Qt.QWidget):

    def __init__(self, puncpat='11'):
        gr.top_block.__init__(self, "Rx Recive")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rx Recive")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rx_recive")
        ...
        self.pld_dec = pld_dec = map( (lambda a: fec.cc_decoder.make(440, k, rate, (polys), 0, -1, fec.CC_TERMINATED, True)), range(0,8) );
        ...
        self.blocks_file_sink_0_0_0_0_1 = blocks.file_sink(gr.sizeof_char*1, '/home/it/Desktop/RX_TEMP.txt', False)
        ...
        self.connect((self.blocks_repack_bits_bb_1, 0), (self.blocks_file_sink_0_0_0_0_1, 0))
...
def main(top_block_cls=rx_recive, options=None):
    if options is None:
