...
class tutorial_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b([255], True, 1, [])
        ...
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_char_to_float_1_0_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_repack_bits_bb_1_0_0_1, 0))
