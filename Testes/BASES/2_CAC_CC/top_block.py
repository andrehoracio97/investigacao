...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.k = k = 7
        self.vector = vector = [int(random.random()*4) for i in range(125600)]
        ...
        self.pld_enc = pld_enc = map( (lambda a: fec.cc_encoder_make(1200, k, rate, (polys), 0, fec.CC_TERMINATED, False)), range(0,8) );


        self.pld_dec = pld_dec = map( (lambda a: fec.cc_decoder.make(1200, k, rate, (polys), 0, -1, fec.CC_TERMINATED, False)), range(0,4) );
        ...
        self.blocks_stream_mux_0_1_0 = blocks.stream_mux(gr.sizeof_char*1, (96, 2416))
        self.blocks_stream_mux_0_0 = blocks.stream_mux(gr.sizeof_char*1, (2412, 4))
        self.blocks_repack_bits_bb_1_0_0_1 = blocks.repack_bits_bb(8, 1, '', False, gr.GR_MSB_FIRST)
        self.blocks_repack_bits_bb_1_0_0_0 = blocks.repack_bits_bb(1, 2, '', False, gr.GR_LSB_FIRST)
        ...
        self.blocks_keep_m_in_n_0_0_2_0 = blocks.keep_m_in_n(gr.sizeof_char, 2412, 2416, 0)
        ...
        self.acode_1104 = blocks.vector_source_b([0x1, 0x0, 0x1, 0x0, 0x1, 0x1, 0x0, 0x0, 0x1, 0x1, 0x0, 0x1, 0x1, 0x1, 0x0, 0x1, 0x1, 0x0, 0x1, 0x0, 0x0, 0x1, 0x0, 0x0, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x1, 0x0, 0x1, 0x1, 0x1, 0x1, 0x0, 0x0, 0x1, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x1, 0x0, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x1, 0x0, 0x1, 0x1, 0x1, 0x0], True, 1, [])
        ...
        self.connect((self.digital_diff_encoder_bb_0, 0), (self.insert_vec_cpp_new_vec_0, 0))
