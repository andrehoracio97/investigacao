...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.vector = vector = [int(random.random()*4) for i in range(2400)]
        ...
        self.blocks_file_source_0_0_1 = blocks.file_source(gr.sizeof_char*1, '/home/andre/Desktop/transmitido/book.txt', False)
        ...
        self.connect((self.blocks_repack_bits_bb_1_0_0_0, 0), (self.blocks_vector_insert_x_0, 0))
        ...
        self.connect((self.blocks_vector_insert_x_0, 0), (self.digital_map_bb_1_0, 0))
