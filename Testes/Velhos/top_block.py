...
# Title: Top Block
# Generated: Fri Jul 12 17:56:32 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0_0_0_0 = blocks.file_source(gr.sizeof_char*1, '/home/andre/Desktop/video2.mpeg', False)
        self.blocks_file_source_0_0_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_1_0 = blocks.file_sink(gr.sizeof_char*1, '/home/andre/Desktop/transmitido/depois.mpeg', False)
        ...
        # Connections
        ##################################################
        self.connect((self.blks2_packet_decoder_0, 0), (self.blocks_file_sink_0_1_0, 0))
        self.connect((self.blks2_packet_encoder_0, 0), (self.digital_constellation_modulator_0, 0))
        self.connect((self.blocks_file_source_0_0_0_0, 0), (self.blocks_throttle_0, 0))
