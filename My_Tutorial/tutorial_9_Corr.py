...
class tutorial_9_Corr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.tx_rrc_taps_0 = tx_rrc_taps_0 = firdes.root_raised_cosine(nfilts, nfilts, 1.0, eb, 5*sps*nfilts)
        ...
        self.rx_rrc_taps_0 = rx_rrc_taps_0 = firdes.root_raised_cosine(nfilts, nfilts*sps, 1.0, eb, 11*sps*nfilts)
        ...
        # Blocks
        ##################################################
        self._variable_qtgui_range_0_1_range = Range(0, 73, 1, 41, 200)
    ...
    def get_rx_rrc_taps_0(self):
        return self.rx_rrc_taps_0

    def set_rx_rrc_taps_0(self, rx_rrc_taps_0):
        self.rx_rrc_taps_0 = rx_rrc_taps_0
