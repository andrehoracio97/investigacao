...
class corr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.connect((self.blocks_stream_mux_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_stream_mux_0, 0), (self.blocks_delay_0_0_0, 0))
    ...
    def set_variable_qtgui_range_1(self, variable_qtgui_range_1):
        ...
        self.blocks_delay_0_0_0.set_dly(self.variable_qtgui_range_1)
