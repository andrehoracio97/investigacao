...
class corr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/andre/Desktop/ruido.txt', False)
        ...
        self.connect((self.blocks_delay_0, 0), (self.custom_corr, 0))
