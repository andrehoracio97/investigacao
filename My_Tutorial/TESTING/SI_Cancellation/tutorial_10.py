...
class tutorial_10(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.connect((self.blocks_keep_m_in_n_0_1_1_0, 0), (self.scrambler_packets_same_seed_descramble_packetize_0, 0))
        ...
        self.connect((self.blocks_stream_mux_0_0_0, 0), (self.blocks_stream_mux_0_1_0, 1))
