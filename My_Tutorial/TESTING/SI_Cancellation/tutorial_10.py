...
class tutorial_10(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.correlate_and_delay_corr_and_delay_0 = correlate_and_delay.corr_and_delay(100, 0, 99)
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, variable_qtgui_range_1)
        ...
        self.connect((self.blocks_delay_0, 0), (self.correlate_and_delay_corr_and_delay_0, 0))
        self.connect((self.blocks_delay_0_0, 0), (self.correlate_and_delay_corr_and_delay_0, 1))
    ...
    def set_variable_qtgui_range_1(self, variable_qtgui_range_1):
        ...
        self.blocks_delay_0.set_dly(self.variable_qtgui_range_1)
    ...
    def get_nfilts_rx(self):
        return self.nfilts_rx

    def set_nfilts_rx(self, nfilts_rx):
        self.nfilts_rx = nfilts_rx
