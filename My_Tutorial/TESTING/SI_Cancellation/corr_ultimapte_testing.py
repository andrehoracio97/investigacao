...
class corr_ultimapte_testing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.adapt_nlms_filter_xx_0 = adapt.nlms_filter_cc(True, 32, 0.01, 0, 1, True, False, False)
        ...
        self.connect((self.adapt_nlms_filter_xx_0, 0), (self.blocks_null_sink_0, 0))
        self.connect((self.adapt_nlms_filter_xx_0, 1), (self.digital_pfb_clock_sync_xxx_0_0_0, 0))
        self.connect((self.analog_noise_source_x_0, 0), (self.interp_fir_filter_xxx_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.adapt_nlms_filter_xx_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.adapt_nlms_filter_xx_0, 1))
