...
class testing_si(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "testing_si")
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.adapt_lms_filter_xx_0, 0))
...
def main(top_block_cls=testing_si, options=None):
    if options is None:
