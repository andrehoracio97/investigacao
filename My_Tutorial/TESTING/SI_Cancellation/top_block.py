...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.custom_corr_0 = correlate_and_delay.corr_and_delay(13, 0, 0.95)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_noise_source_x_0_0, 0), (self.blocks_throttle_0_1, 0))
        self.connect((self.analog_noise_source_x_0_0, 0), (self.blocks_throttle_0_1_0, 0))
        self.connect((self.blocks_complex_to_mag_squared_0_1_0, 0), (self.qtgui_time_sink_x_2_0_1, 0))
        self.connect((self.blocks_delay_0_0, 0), (self.custom_corr_0, 1))
        self.connect((self.blocks_throttle_0_1, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.blocks_throttle_0_1_0, 0), (self.custom_corr_0, 0))
        self.connect((self.custom_corr_0, 2), (self.blocks_complex_to_mag_squared_0_1_0, 0))
        self.connect((self.custom_corr_0, 1), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.custom_corr_0, 0), (self.qtgui_time_sink_x_0_1, 0))
