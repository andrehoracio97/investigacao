...
class self_interference_cancellation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._qtgui_vector_sink_f_0_0_win, 3, 0, 3, 3)
        for r in range(3, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_1_0_win, 15, 1, 1, 1)
        ...
        self.band_pass_filter_0_0 = filter.fir_filter_fff(1, firdes.band_pass(
        	1, samp_rate, 900, 1100, 50, firdes.WIN_HAMMING, 6.76))
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, samp_rate/32, 1, 0)
        self.analog_noise_source_x_0_0 = analog.noise_source_f(analog.GR_GAUSSIAN, 1, 0)
        self.adapt_lms_filter_xx_0_0 = adapt.lms_filter_ff(False, n_taps*2, gui_lms_mu, 0, 1, gui_adapt, False, gui_reset)
        ...
        # Connections
        ##################################################
        self.connect((self.adapt_lms_filter_xx_0_0, 1), (self.qtgui_freq_sink_x_0_0, 2))
        self.connect((self.adapt_lms_filter_xx_0_0, 0), (self.qtgui_freq_sink_x_0_0, 3))
        self.connect((self.adapt_lms_filter_xx_0_0, 2), (self.qtgui_vector_sink_f_0_0, 0))
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.qtgui_freq_sink_x_0_0, 5))
        self.connect((self.band_pass_filter_0_0, 0), (self.adapt_lms_filter_xx_0_0, 1))
        self.connect((self.band_pass_filter_0_0, 0), (self.qtgui_freq_sink_x_1_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0_0.set_taps(firdes.band_pass(1, self.samp_rate, 900, 1100, 50, firdes.WIN_HAMMING, 6.76))
