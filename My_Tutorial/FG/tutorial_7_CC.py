...
class tutorial_7_CC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tutorial_7_CC")
        ...
        self.blocks_file_source_0_0_1_0 = blocks.file_source(gr.sizeof_char*1, '/home/andre/Desktop/Files_To_Transmit/book.txt', False)
...
def main(top_block_cls=tutorial_7_CC, options=None):
    if options is None:
