...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_repack_bits_bb_1_0_0_1_0_0 = blocks.repack_bits_bb(1, 8, '', False, gr.GR_LSB_FIRST)
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/andre/Desktop/Trasmited/encoded.txt', False)
        ...
        self.connect((self.blocks_repack_bits_bb_1_0_0_1_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_repack_bits_bb_1_0_0_1_0_0, 0), (self.blocks_file_sink_0_0, 0))
        self.connect((self.digital_descrambler_bb_0, 0), (self.blocks_repack_bits_bb_1_0_0_1_0, 0))
        self.connect((self.digital_scrambler_bb_0, 0), (self.blocks_repack_bits_bb_1_0_0_1_0_0, 0))
        self.connect((self.digital_scrambler_bb_0, 0), (self.digital_descrambler_bb_0, 0))
