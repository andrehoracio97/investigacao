...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_repack_bits_bb_1_0_0_1_0 = blocks.repack_bits_bb(1, 8, '', False, gr.GR_LSB_FIRST)
        self.blocks_repack_bits_bb_1_0_0_1 = blocks.repack_bits_bb(8, 1, '', False, gr.GR_LSB_FIRST)
