...
\subsection{Modulation - Tutorial\_2.grc}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{whyrrc.png}
    ...
    %Nyquist, RRC+RRC -> RC e Matched Filter e Sample Delay
    ...
    %RRC FILTER TAPS - Explicacao definicao das TAPS
    ...
    %IAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
