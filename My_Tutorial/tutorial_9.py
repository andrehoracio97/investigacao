...
class tutorial_9(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._value_range = Range(0, 10, 0.1, 1, 200)
        self._value_win = RangeWidget(self._value_range, self.set_value, 'Value', "counter_slider", float)
        self.top_grid_layout.addWidget(self._value_win, 0, 3, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_win, 1, 4, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_1_0_win, 2, 4, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_const_sink_x_0_0_0_1_1 = qtgui.const_sink_c(
        	1024, #size
        	"RX Constellation", #name
        	1 #number of inputs
        )
        self.qtgui_const_sink_x_0_0_0_1_1.set_update_time(0.10)
        self.qtgui_const_sink_x_0_0_0_1_1.set_y_axis(-2, 2)
        self.qtgui_const_sink_x_0_0_0_1_1.set_x_axis(-2, 2)
        self.qtgui_const_sink_x_0_0_0_1_1.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, "")
        self.qtgui_const_sink_x_0_0_0_1_1.enable_autoscale(False)
        self.qtgui_const_sink_x_0_0_0_1_1.enable_grid(False)
        self.qtgui_const_sink_x_0_0_0_1_1.enable_axis_labels(True)

        if not True:
          self.qtgui_const_sink_x_0_0_0_1_1.disable_legend()
        ...
        for i in xrange(1):
            if len(labels[i]) == 0:
                self.qtgui_const_sink_x_0_0_0_1_1.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_const_sink_x_0_0_0_1_1.set_line_label(i, labels[i])
            self.qtgui_const_sink_x_0_0_0_1_1.set_line_width(i, widths[i])
            self.qtgui_const_sink_x_0_0_0_1_1.set_line_color(i, colors[i])
            self.qtgui_const_sink_x_0_0_0_1_1.set_line_style(i, styles[i])
            self.qtgui_const_sink_x_0_0_0_1_1.set_line_marker(i, markers[i])
            self.qtgui_const_sink_x_0_0_0_1_1.set_line_alpha(i, alphas[i])

        self._qtgui_const_sink_x_0_0_0_1_1_win = sip.wrapinstance(self.qtgui_const_sink_x_0_0_0_1_1.pyqwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_1_1_win, 2, 6, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(6, 7):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_1_0_0_win, 1, 2, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_0_win, 1, 3, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.digital_fll_band_edge_cc_0_0 = digital.fll_band_edge_cc(sps, eb, 60, 6.28/800.0)
        ...
        self.connect((self.digital_cma_equalizer_cc_0, 0), (self.qtgui_const_sink_x_0_0_0_1_1, 0))
    ...
    def set_samp_rate_array_MCR(self, samp_rate_array_MCR):
        ...
        self.set_samp_rate(self.samp_rate_array_MCR[4])
