...
class tutorial_9(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tutorial_9")
        ...
        self.k = k = 7
        self.zeta = zeta = 1.0
        self.vector = vector = [int(random.random()*7) for i in range(49602)]
        self.variable_qtgui_range_0_1 = variable_qtgui_range_0_1 = 40
        self.variable_qtgui_range_0 = variable_qtgui_range_0 = 50
        self.ted_gain = ted_gain = 1
        self.samp_rate = samp_rate = samp_rate_array_MCR[5]
        ...
        self.pld_const = pld_const = digital.constellation_8psk().base()
        ...
        self.top_grid_layout.addWidget(self._zeta_win, 0, 4, 1, 1)
        for r in range(0, 1):
        ...
        self.top_grid_layout.addWidget(self._ted_gain_win, 0, 3, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        for c in range(4, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_const_sink_x_0_0_0_1_0_1 = qtgui.const_sink_c(
        	1024, #size
        	"RX Treated Constellation", #name
        	1 #number of inputs
        )
        self.qtgui_const_sink_x_0_0_0_1_0_1.set_update_time(0.10)
        self.qtgui_const_sink_x_0_0_0_1_0_1.set_y_axis(-2, 2)
        self.qtgui_const_sink_x_0_0_0_1_0_1.set_x_axis(-2, 2)
        self.qtgui_const_sink_x_0_0_0_1_0_1.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, "")
        self.qtgui_const_sink_x_0_0_0_1_0_1.enable_autoscale(False)
        self.qtgui_const_sink_x_0_0_0_1_0_1.enable_grid(False)
        self.qtgui_const_sink_x_0_0_0_1_0_1.enable_axis_labels(True)

        if not True:
          self.qtgui_const_sink_x_0_0_0_1_0_1.disable_legend()
        ...
        for i in xrange(1):
            if len(labels[i]) == 0:
                self.qtgui_const_sink_x_0_0_0_1_0_1.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_const_sink_x_0_0_0_1_0_1.set_line_label(i, labels[i])
            self.qtgui_const_sink_x_0_0_0_1_0_1.set_line_width(i, widths[i])
            self.qtgui_const_sink_x_0_0_0_1_0_1.set_line_color(i, colors[i])
            self.qtgui_const_sink_x_0_0_0_1_0_1.set_line_style(i, styles[i])
            self.qtgui_const_sink_x_0_0_0_1_0_1.set_line_marker(i, markers[i])
            self.qtgui_const_sink_x_0_0_0_1_0_1.set_line_alpha(i, alphas[i])

        self._qtgui_const_sink_x_0_0_0_1_0_1_win = sip.wrapinstance(self.qtgui_const_sink_x_0_0_0_1_0_1.pyqwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_1_0_1_win, 2, 2, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_1_0_0_win, 1, 1, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_1_0_win, 2, 3, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.digital_symbol_sync_xx_0 = digital.symbol_sync_cc(digital.TED_SIGNAL_TIMES_SLOPE_ML, sps, 6.28*0.04, zeta, ted_gain, 1.5, 1, pld_const.base(), digital.IR_PFB_MF, nfilts, (rx_rrc_taps))
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0_0, 0), (self.qtgui_const_sink_x_0_0_0_1_0_0, 0))
        ...
        self.connect((self.digital_descrambler_bb_0, 0), (self.blocks_repack_bits_bb_0_0, 0))
        ...
        self.connect((self.digital_symbol_sync_xx_0, 0), (self.qtgui_const_sink_x_0_0_0_1_0_1, 0))
    ...
    def set_samp_rate_array_MCR(self, samp_rate_array_MCR):
        ...
        self.set_samp_rate(self.samp_rate_array_MCR[5])
...
def main(top_block_cls=tutorial_9, options=None):
    if options is None:
