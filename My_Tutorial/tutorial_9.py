...
class tutorial_9(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.connect((self.blocks_multiply_conjugate_cc_0, 0), (self.pfb_arb_resampler_xxx_0, 0))
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0_0, 0), (self.blocks_multiply_conjugate_cc_0, 1))
        ...
        self.connect((self.digital_costas_loop_cc_0_0, 0), (self.digital_diff_phasor_cc_0, 0))
        self.connect((self.digital_diff_phasor_cc_0, 0), (self.digital_constellation_decoder_cb_0_0, 0))
