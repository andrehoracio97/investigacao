...
class tutorial_9(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.pld_enc = pld_enc = map( (lambda a: fec.cc_encoder_make(100, k, rate, (polys), 0, fec.CC_TERMINATED, False)), range(0,4) );


        self.pld_dec = pld_dec = map( (lambda a: fec.cc_decoder.make(100, k, rate, (polys), 0, -1, fec.CC_TERMINATED, False)), range(0,8) );
        ...
        self.blocks_vector_source_x_0_0_0 = blocks.vector_source_b([1,1,1,1], True, 1, [])
        self.blocks_stream_mux_0_1_0 = blocks.stream_mux(gr.sizeof_char*1, (96,  216))
        self.blocks_stream_mux_0_0 = blocks.stream_mux(gr.sizeof_char*1, (212, 1))
        ...
        self.blocks_keep_m_in_n_0_0_2_0 = blocks.keep_m_in_n(gr.sizeof_char, 212, 216, 0)
        self.blocks_file_source_0_0_1_0_0 = blocks.file_source(gr.sizeof_char*1, '/home/andre/Desktop/Trasmited/videofhd.mpg', False)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/andre/Desktop/encoded.txt', False)
        ...
        self.acode_1104 = blocks.vector_source_b([0x1, 0x0, 0x1, 0x0, 0x1, 0x1, 0x0, 0x0, 0x1, 0x1, 0x0, 0x1, 0x1, 0x1, 0x0, 0x1, 0x1, 0x0, 0x1, 0x0, 0x0, 0x1, 0x0, 0x0, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x1, 0x0, 0x1, 0x1, 0x1, 0x1, 0x0, 0x0, 0x1, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x1, 0x1], True, 1, [])
        ...
        self.connect((self.blocks_stream_mux_0_0, 0), (self.blocks_repack_bits_bb_1, 0))
