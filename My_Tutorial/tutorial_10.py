...
class tutorial_10(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_1_win, 5, 3, 1, 1)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_1_1_win, 4, 4, 1, 1)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_1_0_win, 1, 4, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_1_win, 2, 3, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.adapt_nlms_filter_xx_0 = adapt.nlms_filter_cc(True, 32*100, 0.1, 0, 1, True, False, False)
        ...
        self.connect((self.adapt_nlms_filter_xx_0, 1), (self.digital_pfb_clock_sync_xxx_0, 0))
        self.connect((self.adapt_nlms_filter_xx_0, 1), (self.qtgui_freq_sink_x_0_1, 0))
        self.connect((self.adapt_nlms_filter_xx_0, 0), (self.qtgui_freq_sink_x_0_1_1, 0))
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.adapt_nlms_filter_xx_0, 1))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.adapt_nlms_filter_xx_0, 0))
        ...
        self.connect((self.digital_costas_loop_cc_0_0, 0), (self.qtgui_freq_sink_x_0_2, 0))
        self.connect((self.digital_costas_loop_cc_0_0, 0), (self.qtgui_time_sink_x_1_1, 0))
