...
class tutorial_10(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        _variable_qtgui_check_box_0_check_box = Qt.QCheckBox('JAMMING')
        ...
        self.top_grid_layout.addWidget(_variable_qtgui_check_box_0_check_box, 0, 5, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(5, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.uhd_usrp_sink_0.set_gain(gain_jamming, 0)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_0_0_win, 3, 2, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_0_0_win, 3, 1, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.blocks_copy_0_0.set_enabled(variable_qtgui_check_box_0)
        ...
        self.adapt_lms_filter_xx_0 = adapt.lms_filter_cc(False, 16, gui_lms_mu, 0, sps, True, False, False)
        ...
        self.connect((self.adapt_lms_filter_xx_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.blocks_copy_0_0, 0))
        ...
        self.connect((self.blocks_copy_0_0, 0), (self.blocks_multiply_const_vxx_1_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.adapt_lms_filter_xx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.qtgui_const_sink_x_0_0_0_0_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.adapt_lms_filter_xx_0, 1))
    ...
    def set_variable_qtgui_check_box_0(self, variable_qtgui_check_box_0):
        ...
        self._variable_qtgui_check_box_0_callback(self.variable_qtgui_check_box_0)
        self.blocks_copy_0_0.set_enabled(self.variable_qtgui_check_box_0)
    ...
    def get_gain_jamming(self):
        return self.gain_jamming

    def set_gain_jamming(self, gain_jamming):
        self.gain_jamming = gain_jamming
        self.uhd_usrp_sink_0.set_gain(self.gain_jamming, 0)
