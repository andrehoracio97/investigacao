...
class tutorial_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_float_to_char_0 = blocks.float_to_char(1, 8)
        ...
        self.connect((self.blocks_float_to_char_0, 0), (self.digital_map_bb_0_0_0, 0))
        ...
        self.connect((self.digital_constellation_soft_decoder_cf_0, 0), (self.blocks_float_to_char_0, 0))
