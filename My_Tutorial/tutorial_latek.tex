...
\subsection{USRP - Tutorial\_9.grc}
    ...
    The scramble at this view has nothing related to encryption but aims to eliminate long sequence of same bits (called whitening sequences), reducing problems with synchronization at the receiver, it works using a LFSR (linear-feedback shift register) by 
