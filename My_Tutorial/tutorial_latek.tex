...
\subsection{USRP - Tutorial\_10.grc}
    ...
    %--TBM adicionai uma check box para simular cancelamento completo de transmissao
...
\subsection{USRP - Tutorial\_9.grc}
    ...
    %---Explicar que se fizer usar os nativos se perder um pedaco perde-se tudo. - É dependente -- Solucao temos que fazer por pacotes e resetar os registos.
