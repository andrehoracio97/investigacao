...
class bob(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.bob_hier, 2), (self.blocks_char_to_float_1_0_1, 0))
        self.connect((self.bob_hier, 2), (self.blocks_file_sink_0_0_0_0_2, 0))
        self.connect((self.bob_hier, 1), (self.blocks_null_sink_2, 0))
