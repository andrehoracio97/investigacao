...
# Generated: Mon Jul 29 11:43:42 2019
##################################################
...
class constellation_soft_decoder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, '/home/andre/Desktop/letra.txt', True)
        ...
        self.connect((self.digital_binary_slicer_fb_0, 0), (self.blocks_repack_bits_bb_0_0_0, 0))
