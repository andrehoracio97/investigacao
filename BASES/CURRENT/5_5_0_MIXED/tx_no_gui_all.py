...
class tx_no_gui_all(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11', puncpat2=1073741823, puncpat2_size=32):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_no_gui_all")
        ...
        self.uhd_usrp_source_0_0_0.set_center_freq(frequencia_usrp, 0)
        self.uhd_usrp_source_0_0_0.set_gain(variable_qtgui_range_0_1_0, 0)
        ...
        self.uhd_usrp_sink_0.set_gain(variable_qtgui_range_0_0_0, 0)
        self.uhd_usrp_sink_0.set_antenna('TX/RX', 0)
        self.scrambler_cpp_additive_scrambler_0 = scrambler_cpp.additive_scrambler(0x8A, 0x7F, 7, 440-32)
        self.scrambler_cpp_additive_descrambler_0_0 = scrambler_cpp.additive_descrambler(0x8A, 0x7F, 7, 440-32)
        ...
        self.qtgui_freq_sink_x_0_0_2 = qtgui.freq_sink_c(
        	...
        	0, #fc
        	samp_rate, #bw
        	"Bob Tx Jamming Frequency", #name
        	1 #number of inputs
        )
        self.qtgui_freq_sink_x_0_0_2.set_update_time(0.10)
        self.qtgui_freq_sink_x_0_0_2.set_y_axis(-140, 10)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_2_win, 1, 5, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(5, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self._qtgui_const_sink_x_0_0_0_2_win = sip.wrapinstance(self.qtgui_const_sink_x_0_0_0_2.pyqwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_2_win, 4, 2, 1, 1)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_1_0_win, 4, 1, 1, 1)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.digital_costas_loop_cc_0_0_0 = digital.costas_loop_cc(6.28/100.0, pld_const.arity(), False)
        ...
        self.blocks_keep_m_in_n_0_1_1_0_0 = blocks.keep_m_in_n(gr.sizeof_char, 440, 442, 0)
        ...
        self.connect((self.blocks_char_to_float_0_2_0_0_0_0, 0), (self.fec_extended_decoder_0_0_1_0_1_0_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.qtgui_freq_sink_x_0_0_2, 0))
        ...
        self.connect((self.scrambler_cpp_additive_descrambler_0_0, 0), (self.blocks_repack_bits_bb_0_0_0_1_0_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0_0_0, 0), (self.digital_pfb_clock_sync_xxx_0_0, 0))
        self.connect((self.uhd_usrp_source_0_0_0, 0), (self.qtgui_const_sink_x_0_0_0_1_0, 0))
    ...
    def set_variable_qtgui_range_0_1_0(self, variable_qtgui_range_0_1_0):
        ...
        self.uhd_usrp_source_0_0_0.set_gain(self.variable_qtgui_range_0_1_0, 0)
    ...
    def set_variable_qtgui_range_0_0_0(self, variable_qtgui_range_0_0_0):
        ...
        self.uhd_usrp_sink_0.set_gain(self.variable_qtgui_range_0_0_0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0_0_2.set_frequency_range(0, self.samp_rate)
    ...
    def set_frequencia_usrp(self, frequencia_usrp):
        ...
        self.uhd_usrp_source_0_0_0.set_center_freq(self.frequencia_usrp, 0)
...
def main(top_block_cls=tx_no_gui_all, options=None):
    if options is None:
