...
class all_in_one(gr.top_block, Qt.QWidget):

    def __init__(self, puncpat='11'):
        gr.top_block.__init__(self, "All In One")
        ...
        self.settings = Qt.QSettings("GNU Radio", "all_in_one")
...
def main(top_block_cls=all_in_one, options=None):
    if options is None:
