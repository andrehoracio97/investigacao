...
class rx_eve(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.blocks_file_sink_0_0_0_0_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/andre/Desktop/Trasmited/11/EVE.txt', False)
        ...
        self.connect((self.digital_costas_loop_cc_0_0, 0), (self.blocks_file_sink_0_0_0_0_0_0, 0))
