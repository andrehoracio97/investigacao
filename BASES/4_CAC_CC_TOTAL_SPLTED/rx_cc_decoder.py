...
class rx_cc_decoder(gr.top_block, Qt.QWidget):

    def __init__(self, puncpat='11'):
        gr.top_block.__init__(self, "Rx Cc Decoder")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rx Cc Decoder")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rx_cc_decoder")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/it/Desktop/RX_TEMP.txt', False)
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_keep_m_in_n_0_0_2_0, 0))
...
def main(top_block_cls=rx_cc_decoder, options=None):
    if options is None:
