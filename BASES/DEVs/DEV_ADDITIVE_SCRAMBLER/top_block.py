...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, '/home/andre/Desktop/Files_To_Transmit/sequence54.txt', False)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_file_source_0_0, 0), (self.blocks_repack_bits_bb_0, 0))
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.scrambler_cpp_additive_scrambler_0, 0))
        self.connect((self.blocks_repack_bits_bb_1, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.scrambler_cpp_additive_descrambler_0, 0), (self.blocks_repack_bits_bb_1, 0))
        self.connect((self.scrambler_cpp_additive_scrambler_0, 0), (self.scrambler_cpp_additive_descrambler_0, 0))
