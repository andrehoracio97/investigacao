...
class tutorial_7_LDPC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_b([0x1, 0x0, 0x1, 0x0, 0x0, 0x1, 0x1, 0x1, 0x0, 0x1, 0x1, 0x0, 0x0, 0x0, 0x1], True, 1, [])
        ...
        self.blocks_stream_mux_0_1_0 = blocks.stream_mux(gr.sizeof_char*1, (25,155, 1104))
        ...
        self.connect((self.blocks_repack_bits_bb_1_0_0_1, 0), (self.blocks_stream_mux_0_1_0, 2))
        ...
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_stream_mux_0_1_0, 1))
        self.connect((self.blocks_vector_source_x_0_0, 0), (self.blocks_stream_mux_0_1_0, 0))
