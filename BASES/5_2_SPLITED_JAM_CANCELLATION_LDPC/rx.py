...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.pld_dec = pld_dec = map((lambda a: fec.ldpc_bit_flip_decoder.make(H_dec.get_base_sptr(), 150)), range(0,8))
        ...
        self.adapt_lms_filter_xx_0 = adapt.lms_filter_cc(True, 32, 0.025, 0, 1, True, False, False)
        ...
        self.connect((self.blocks_keep_m_in_n_0_1_1_0, 0), (self.blocks_repack_bits_bb_0_0_0_1_0_0, 0))
        ...
        self.connect((self.blocks_repack_bits_bb_0_0_0_1_0_0, 0), (self.blocks_file_sink_0_0_0_0_1, 0))
