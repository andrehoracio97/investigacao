...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.scrambler_cpp_additive_descrambler_0, 0))
        ...
        self.connect((self.scrambler_cpp_additive_descrambler_0, 0), (self.digital_correlate_access_code_xx_ts_0_0, 0))
