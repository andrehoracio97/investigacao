...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.samp_rate = samp_rate = samp_rate_array_MCR[18]
        ...
        self.adapt_rls_filter_xx_0 = adapt.rls_filter_cc(True, 32, gui_delta, gui_lambda, 1, 1, True, False)
        ...
        # Connections
        ##################################################
        self.connect((self.adapt_rls_filter_xx_0, 0), (self.blocks_null_sink_0, 0))
        ...
        self.connect((self.custom_corr, 0), (self.adapt_rls_filter_xx_0, 1))
        self.connect((self.custom_corr, 1), (self.adapt_rls_filter_xx_0, 0))
    ...
    def set_samp_rate_array_MCR(self, samp_rate_array_MCR):
        ...
        self.set_samp_rate(self.samp_rate_array_MCR[18])
