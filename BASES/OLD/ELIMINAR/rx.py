...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self._variable_qtgui_range_0_0_0_0_win = RangeWidget(self._variable_qtgui_range_0_0_0_0_range, self.set_variable_qtgui_range_0_0_0_0, 'Delay2', "counter_slider", int)
        self.top_grid_layout.addWidget(self._variable_qtgui_range_0_0_0_0_win, 3, 3, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._variable_qtgui_range_0_0_0_range = Range(0, 5000, 1, 0, 200)
        self._variable_qtgui_range_0_0_0_win = RangeWidget(self._variable_qtgui_range_0_0_0_range, self.set_variable_qtgui_range_0_0_0, 'Delay', "counter_slider", int)
        self.top_grid_layout.addWidget(self._variable_qtgui_range_0_0_0_win, 3, 1, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.custom_corr = correlate_and_delay.corr_and_delay(200*sps, 0, 0.999, sps)
        ...
        self.blocks_file_sink_0_0_0_0_2_0 = blocks.file_sink(gr.sizeof_char*1, '/home/andre/Desktop/Trasmited/buffer.txt', False)
        ...
        self.adapt_lms_filter_xx_0 = adapt.lms_filter_ff(True, 32, 0.0001, 0, 1, True, False, False)
        ...
        self.connect((self.blocks_repack_bits_bb_0_0, 0), (self.blocks_file_sink_0_0_0_0_2_0, 0))
        ...
        self.connect((self.blocks_stream_to_streams_0, 0), (self.blocks_float_to_complex_0, 1))
        self.connect((self.blocks_stream_to_streams_0, 1), (self.blocks_float_to_complex_0, 0))
