...
class packet_loopback_hier(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/andre/Desktop/video.mpg', True)
        ...
        self.connect((self.blocks_file_source_0, 0), (self.blocks_char_to_float_1_0_0, 0))
        self.connect((self.blocks_file_source_0, 0), (self.packet_tx_0, 0))
        ...
        self.connect((self.packet_rx_0, 0), (self.blocks_file_sink_0_0_0_1, 0))
