...
class packet_loopback_hier(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0_0_1 = blocks.file_source(gr.sizeof_char*1, '/home/andre/git/investigacao/Testes/EVOLUCAO/11TESTAR_CORRETALE_TAG/book.txt', False)
        self.blocks_file_source_0_0_1.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/andre/git/investigacao/Testes/EVOLUCAO/11TESTAR_CORRETALE_TAG/depois.txt', False)
