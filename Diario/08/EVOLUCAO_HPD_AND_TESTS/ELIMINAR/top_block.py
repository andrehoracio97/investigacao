...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/andre/git/investigacao/Testes/EVOLUCAO/TESTES_SLACK/book.txt', False)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/andre/git/investigacao/Testes/EVOLUCAO/TESTES_SLACK/repack.txt', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/andre/git/investigacao/Testes/EVOLUCAO/TESTES_SLACK/depois.txt', False)
