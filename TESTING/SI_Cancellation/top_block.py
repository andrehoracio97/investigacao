...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.custom_corr = correlate_and_delay.corr_and_delay(13, 0, 0.99, 1)
        self.blocks_throttle_0_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_stream_mux_0 = blocks.stream_mux(gr.sizeof_gr_complex*1, (13,5000))
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, 900)
        ...
        self.connect((self.custom_corr, 2), (self.qtgui_time_sink_x_2_0_0, 0))
        self.connect((self.vec, 0), (self.blocks_stream_mux_0, 0))
        self.connect((self.vec, 0), (self.blocks_throttle_0_0, 0))
