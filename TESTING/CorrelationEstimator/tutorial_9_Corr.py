...
class tutorial_9_Corr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, puncpat='11'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tutorial_9_Corr")
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_1_win, 3, 1, 1, 2)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_0_win, 3, 3, 1, 2)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.digital_pfb_clock_sync_xxx_0_0 = digital.pfb_clock_sync_ccf(sps, 6.28/400.0, (rx_psf_taps), nfilts, nfilts/2, 1.5, 1)
        ...
        self.digital_correlate_access_code_xx_ts_0_0 = digital.correlate_access_code_bb_ts(digital.packet_utils.default_access_code,
          1, 'packet_len')
        self.digital_corr_est_cc_0 = digital.corr_est_cc((modulated_sync_word), sps, mark_delay, 0.990)
        ...
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_gr_complex, 1, 496, "packet_len")
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        ...
        self.connect((self.insert_vec_cpp_new_vec_0, 0), (self.blocks_repack_bits_bb_0_1, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.qtgui_const_sink_x_0_0_0_0, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.uhd_usrp_sink_0_0, 0))
...
def main(top_block_cls=tutorial_9_Corr, options=None):
    if options is None:
